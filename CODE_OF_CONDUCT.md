...
This Code of Conduct applies within all community spaces — GitHub Issues, Pull Requests, Discussions, and any other forums — and also applies when an individual is officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the project team at **conduct@magb.dev** (or by opening a confidential issue).
...
**Consequence:** A warning with consequences for continued behavior. No interaction with the people involved for a specified period, including in community spaces and external channels.
